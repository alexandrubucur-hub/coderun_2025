...
const navigation = [
     { name: "Best Cluj-Napoca", href: "https://bestcj.ro/", current: false },
];
                                        ...
                                        {navigation.map((item) => (
                                             <a
                                                  ...
                                                  className={classNames(
                                                       ...
                                                       "rounded-md px-3 py-2 text-md font-medium myFont" // fontul custom aici
                                                  )}
                                             >
                                                  {item.name}
                                             </a>
                              ...
                              <DisclosureButton
                                   ...
                                   className={classNames(
                                        item.current
                                             ? "bg-gray-950/50 text-white"
                                             : "text-gray-300 hover:bg-white/5 hover:text-white",
                                        "block rounded-md px-3 py-2 text-base font-medium myFont" // fontul custom
                                   )}
                              >
                                   {item.name}
                              </DisclosureButton>
